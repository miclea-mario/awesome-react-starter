...
/**
 * Examples index page component.
 *
 * @returns {React.ReactElement} The rendered examples page.
 */
const Page = () => {
  return (
    <>
      <div className="flex items-center gap-2 mb-4">
        <span className="text-sm text-muted-foreground">About the dashboard:</span>
        <Tooltip>
...
/**
 * Attaches the standard layout to the page.
 *
